...
type MemberClient interface {
	CreateProjectMember(ctx context.Context, txn *newrelic.Transaction, arg *memberService.MemberRequest) (*memberService.MemberResponse, error)
...
func (m *memberClient) CreateProjectMember(ctx context.Context, txn *newrelic.Transaction, arg *memberService.MemberRequest) (*memberService.MemberResponse, error) {
	defer txn.StartSegment("CreateProjectMember-client").End()
	return m.client.CreateMember(ctx, arg)
}

func (m *memberClient) GetProjectMembers(ctx context.Context, txn *newrelic.Transaction, projectId string) ([]*memberService.MemberResponse, error) {
	defer txn.StartSegment("GetProjectMembers-client").End()
...
func (m *memberClient) UpdateProjectMember(ctx context.Context, txn *newrelic.Transaction, arg *memberService.MemberRequest) (*memberService.MemberResponse, error) {
	defer txn.StartSegment("UpdateProjectMember-client").End()
